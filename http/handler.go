...
func NewHandler(svc *application.FavouriteService) *Handler {
	return &Handler{svc: svc}
}

func (h *Handler) GetUserFavourites(w http.ResponseWriter, r *http.Request) {
	// Expect: /users/{userId}/favourites
